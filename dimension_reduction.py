...
def create_2d_umap(dataX, dataY, random_state=0, n_neighbor=15):
    ...
    dataY = [0 for _ in range(index_count[0])]
    mapper = umap.UMAP(
        n_components=2,
...
def create_3d_umap(dataX, dataY, random_state=0, n_neighbor=15):
